...
private slots:
    ...
    void on_treeView_diretorio_imagem_filtro_clicked(const QModelIndex &index);
    ...
    void on_radioButton_filtro_CLAHE_clicked();    
    void on_radioButton_filtro_media_clicked();
